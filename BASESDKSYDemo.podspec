Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/yuhaomingming/BASESDKSYDemo.git", :tag => "0.0.25" }
  ...
  s.xcconfig = {"OTHER_LDFLAGS[arch=arm64]" => "Common/SDK/Platform/BASESDK/SYFramework/QuickUnifyPlatform.framework","OTHER_LDFLAGS[arch=armv7]" => "Common/SDK/Platform/BASESDK/SYFramework/QuickUnifyPlatform.framework"}
