Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/yuhaomingming/BASESDKSYDemo.git", :tag => "0.0.21" }
  ...
  s.requires_arc            = true
  s.pod_target_xcconfig = { "OTHER_LDFLAGS" => "-lObjC" , "ARCHITECTURES" => "$(ARCHS_STANDARD)"}
  #s.xcconfig = { "ARCHITECTURES" => "$(ARCHS_STANDARD)" ,"VALID_ARCHITECTURES" => "arm64 armv7 armv7s"}
